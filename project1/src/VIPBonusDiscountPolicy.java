 ...
 * This class applies a base percentage and an additional bonus if the amount exceeds a threshold.
 */
...
public class VIPBonusDiscountPolicy implements DiscountPolicy {
    ...
    private double bonusThreshold; // เงื่อนไขโดย amount ที่จ่ายมากกว่า bonusThreshold จะให้ส่วนลดพิเศษ
                                   // (bonusPercent) + basePercent
